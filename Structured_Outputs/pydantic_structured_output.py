...
#     sentiment: Literal["pos", "neg"] = Field(description="Return sentiment of the review either negative, poistive, netural")
...
# Expensive compared to competitors Review by Nitish""")
...
# Claude model (REPLACES HuggingFace)
model = ChatAnthropic(
...
# structured output (THIS NOW WORKS with Claude)
structured_model = model.with_structured_output(Review)
